...
import namtechcom.hackathon_project.face.claas;

public class WelcomoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_welcomo);
    ...
    private void launchHomeScreen() {
        Intent intent = new Intent(this, claas.class);
